...
const aboutInfo = [
  {
    head: "Somali Student Association",
    description: "I'm currently the treasurer for Carleton's Somali Students Association where we hold events and panels to introduce Soamli culture to members of the Carleton community!",
  ...
  {
    head: "Hobbies",
    description: "Some of my other hobbies include scenic biking & hiking, playing NBA 2k & board games with friends and trying new dishes!",
    link: "",
  },
]
      ...
      <div className="my-12 pb-12 md:pt-24 md:pb-38">
        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2 ">
            ...
            <p>
              Hi, I'm Abdiqani, from Ottawa! I enjoy solving challenging problems, and I do it with the use of code!

              I'm a Sophmore at Carleton University, where I'm studying Computer Science.
              In particular, I love learning about cybersecurity and working with
